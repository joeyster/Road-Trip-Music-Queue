...
let redirect_uri = "http://joeyliao.ddns.net:8888/callback"; // Or Your redirect uri
...
app.get("/api", function(req, res) {
  ...
  res.setHeader("Access-Control-Allow-Origin", "http://joeyliao.ddns.net:3000");
