...
class LogIn extends Component {
  ...
  clear_playlist = () => {
    let url = "https://wavesterioapi.herokuapp.com/clear_playlist";
    let options = {
      method: "POST",
      mode: "cors",
      headers: {
  ...
  create_playlist = () => {
    let url = "https://wavesterioapi.herokuapp.com/create_playlist";
    let options = {
      method: "POST",
      mode: "cors",
      headers: {
  ...
  authorization = () => {
    ...
    document.location.href = "https://wavesterioapi.herokuapp.com/";
  };
