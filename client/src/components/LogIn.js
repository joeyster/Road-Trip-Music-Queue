...
class LogIn extends Component {
  ...
  clear_playlist = () => {
    let url = "http://joeyliao.ddns.net:8888/clear_playlist";
    let options = {
      method: "POST",
      mode: "cors",
      headers: {
  ...
  create_playlist = () => {
    let url = "http://joeyliao.ddns.net:8888/create_playlist";
    let options = {
      method: "POST",
      mode: "cors",
      headers: {
  ...
  authorization = () => {
    ...
    document.location.href = "http://joeyliao.ddns.net:8888";
  };
